    ...
    <BaseDialog isOpen={isOpen} setisOpen={setIsOpen} title="" description="">
      ...
      <form onSubmit={handleSubmit(onSub)} className="space-y-5">
        <div className="space-y-2">
          ...
          <Input id="name" placeholder="What do you want to achieve?" {...register("name", { required: true })} />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="description" placeholder="Add details about your goal" {...register("description")} />
        </div>
